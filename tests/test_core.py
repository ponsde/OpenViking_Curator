...
class TestLoadContext(unittest.TestCase):
        ...
        items = [
            {
                "uri": "a",
                "score": 0.8,
                "abstract": "A detailed abstract about Docker deployment with Nginx reverse proxy and SSL configuration. "
                * 3,
            },
            {
                "uri": "b",
                "score": 0.7,
                "abstract": "Another detailed abstract about container orchestration and systemd service management. "
                * 3,
            },
        ]
    ...
    def test_max_l2_respected(self):
        ...
        items = [{"uri": f"item_{i}", "score": 0.8 - i * 0.01, "abstract": "abs"} for i in range(5)]
...
class TestLogQuery(unittest.TestCase):
    ...
    def test_log_query_writes_jsonl(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            _ = pv2.DATA_PATH if hasattr(pv2, "DATA_PATH") else None  # noqa: F841
            try:
